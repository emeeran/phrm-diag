...
import { InfoIcon, KeyIcon, AlertTriangle } from 'lucide-react';
...
// Placeholder component for MFA setup
const MFASetup = ({ onComplete, onCancel }: { onComplete: () => void, onCancel: () => void }) => {
  return (
    <div className="space-y-4">
      ...
      <div className="flex justify-center py-4">
        <div className="bg-secondary h-40 w-40 flex items-center justify-center">
                ...
                <div className="bg-secondary p-4 rounded-md">
                  <div className="flex justify-between items-center">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        {new Date().toLocaleString()} • {typeof navigator !== 'undefined' ? navigator.platform : 'Unknown'}
                      </p>
                    </div>
